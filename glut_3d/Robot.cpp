...
Object* Robot::mains()
{
	...
	poly  = new Polygone();
	poly->addVertex(Polygone::Vertex(0.0f,y+0.1f,0.0f));
	poly->addVertex(Polygone::Vertex(0.0f,y+0.05f,0.0f));
	poly->addVertex(Polygone::Vertex(0.0f,y+0.05f,0.1f));
	poly->addVertex(Polygone::Vertex(0.0f,y+0.1f,0.08f));
	_base->addObject(poly);

	poly  = new Polygone();
	poly->addVertex(Polygone::Vertex(0.0f,y+0.2f,0.0f));
	poly->addVertex(Polygone::Vertex(0.0f,y+0.1f,0.0f));
	poly->addVertex(Polygone::Vertex(0.0f,y+0.1f,0.1f));
	poly->addVertex(Polygone::Vertex(0.0f,y+0.2f,0.08f));
	_base->addObject(poly);

	ct = (Container*)doigt_complete();
	ct->setPosition(0.0f,0.05f+0.15f,0.05f);
	ct->setPosition(ct->getPosition()-ct->getRepere());
	_base->addObject(ct);

	ct = (Container*)doigt_complete();
	ct->setPosition(0.0f,0.05f+0.3f,0.05f);
	ct->setPosition(ct->getPosition()-ct->getRepere());
	_base->addObject(ct);


	ct = (Container*)doigt_complete();
	ct->setPosition(0.0f,0.05f+0.45f,0.05f);
	ct->setPosition(ct->getPosition()-ct->getRepere());
	_base->addObject(ct);
